...
import { WorksDsFreelanceDeveloper } from "@/components/WorksDsFreelanceDeveloper";
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: siteUrl("/works/ds-freelance-developer") },
  openGraph: {
    title: "DS Freelance Developer - My Framer Site",
    description:
      "Norvin is a premium Framer template for agencies and creatives to showcase work with modern layouts, smooth interactions, and high performance. Launch a professional portfolio quickly and stand out.",
    url: siteUrl("/works/ds-freelance-developer"),
