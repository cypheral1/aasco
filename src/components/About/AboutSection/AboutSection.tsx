  ...
  return (
    <section className={styles.aboutSection}>
      <div className={styles.top2}>
          ...
          <div className={styles.definingTheFuture} data-code-component-plugin-id={"84d4c1"}>
            ...
            <div className={styles.definingTheFuture3}>
              ...
              <span className={styles.span2}>
                <span className={styles.page} data-framecoded-motion={"r837"}>
                  {" "}
                </span>
              </span>
              ...
              <span className={styles.crafting}>
                <span className={styles.crafting2} data-framecoded-motion={"r83n"}>
                  crafting{" "}
                </span>
              </span>
        ...
        <div className={styles.image5} data-framecoded-motion={"r6ie"}>
          <div className={styles.image6}>
            <Image
              className={styles.image7}
              src={
                "https://framerusercontent.com/images/cMgOK9Ll5ZGWnUhkP6BKLP58Bmc.png?width=324&height=325"
              }
              alt={"image"}
              width={324}
              height={325}
              srcSet={
                "/assets/cMgOK9Ll5ZGWnUhkP6BKLP58Bmc-98de5b11e8.png 162w, /assets/cMgOK9Ll5ZGWnUhkP6BKLP58Bmc-9265dee139.png 324w, /assets/cMgOK9Ll5ZGWnUhkP6BKLP58Bmc-f6efb2ec93.png 648w"
              }
      ...
      <div className={styles.numberWrap} data-border={"true"}>
        <div className={styles.p35}>
          <div className={styles.p352}>
