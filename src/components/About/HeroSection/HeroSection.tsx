...
export function HeroSection() {
  return (
    <section className={styles.heroSection}>
      ...
      <Link href={"/#top"} className={styles.logo} data-framecoded-motion={"r6h4"}>
      ...
      <div className={styles.heading}>
        <div className={styles.about} data-framecoded-motion={"r6h6"}>
      ...
      <div className={styles.detailPlus1} data-framecoded-motion={"r6hh"}>
        <div className={styles.plus}>
          <div className={styles.el}></div>
          <div className={styles.el2}></div>
        </div>
      </div>
      <div className={styles.detailPlus2} data-framecoded-motion={"r6hl"}>
        <div className={styles.plus2}>
          <div className={styles.el3}></div>
          <div className={styles.el4}></div>
        </div>
      </div>
      <div className={styles.detailPlus3} data-framecoded-motion={"r6hp"}>
