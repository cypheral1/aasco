  ...
  return (
    <section className={styles.hireUsSection}>
      <div className={styles.hireUs}>
          ...
          <div className={styles.left13}>
            ...
            <div className={styles.bottom13}>
              ...
              <div className={styles.startProject62}>
                <Link
                  href={"/contact#top"}
                  className={styles.secondary25}
                  data-border={"true"}
                  data-framecoded-trigger={"htb09l6"}
                >
                  <div className={styles.filler5} data-framecoded-state={"htb09l6s0"}></div>
        ...
        <div className={styles.clientTicker} data-framecoded-motion={"r763"}>
          <ul className={styles.logoImageList} data-framecoded-motion={"r762"}>
            <li
              ...
              aria-setsize={"7"}
            >
              <div className={styles.mask5}></div>
            </li>
            <li
              ...
              aria-posinset={"2"}
              aria-setsize={"7"}
              data-framecoded-motion={"r75c"}
            >
              <div className={styles.logoImage2}>
                <div className={styles.primary53}>
            ...
            >
              <div className={styles.logoImage5}>
                <div className={styles.primary54}>
            ...
            >
              <div className={styles.logoImage8}>
                <div className={styles.primary55}>
            ...
            <li
              ...
              aria-posinset={"5"}
              aria-setsize={"7"}
              data-framecoded-motion={"r75r"}
            >
              <div className={styles.logoImage11}>
                <div className={styles.primary56}>
            ...
            >
              <div className={styles.logoImage14}>
                <div className={styles.primary57}>
            ...
            >
              <div className={styles.logoImage17}>
                <div className={styles.primary58}>
          ...
          <div className={styles.logoImage20}>
            <div className={styles.primary462}>
          ...
          <div className={styles.logoImage23}>
            <div className={styles.primary472}>
          ...
          <div className={styles.logoImage26}>
            <div className={styles.primary482}>
          ...
          <div className={styles.logoImage29}>
            <div className={styles.primary492}>
          ...
          <div className={styles.logoImage32}>
            <div className={styles.primary502}>
      ...
      <div className={styles.mask6}></div>
      <div className={styles.map}>
        <div className={styles.image28}>
          <Image
            ...
            sizes={
              "(min-width: 1440px) 1302px, (min-width: 810px) and (max-width: 1439.98px) 1302px, (max-width: 809.98px) 1302px"
            }
          />
        </div>
      </div>
