import styles from "./ImageSection2.module.css";
import { Image } from "../../../ui/Image";
import Link from "next/link";
export function ImageSection2() {
  return (
    <section className={styles.imageSection2}>
            ...
            <div className={styles.lInks}>
              <div className={styles.helloNorvinAgency0278346236}>
                <p className={styles.helloNorvinAgency} dir={"auto"}>
                  <a
                    href={"mailto:hello@norvin.agency"}
                    target={"_blank"}
          ...
          <div className={styles.menuLinks}>
            ...
            <div className={styles.list}>
              <div className={styles.about4}>
                ...
                >
                  <div className={styles.about22} data-framecoded-state={"h1ro8n0ws0"}>
                    <p className={styles.about5} dir={"auto"}>
                      About
                    </p>
                  </div>
                </Link>
              ...
              <div className={styles.work}>
                ...
                >
                  <div className={styles.about32} data-framecoded-state={"hvuojy7s0"}>
              ...
              <div className={styles.news}>
                <Link
                  href={"/news"}
                  className={styles.primary61}
                  data-framecoded-trigger={"h1ekoo6w"}
                  data-framecoded-state={"h1ekoo6wsroot"}
                >
                  <div className={styles.about42} data-framecoded-state={"h1ekoo6ws0"}>
              ...
              <div className={styles.privacy}>
                <Link
                  href={"/privacy-policy"}
                  className={styles.primary62}
                  data-framecoded-trigger={"h2a4k0a"}
                  data-framecoded-state={"h2a4k0asroot"}
                >
                  <div className={styles.about52} data-framecoded-state={"h2a4k0as0"}>
              ...
              <div className={styles.contact2}>
                <Link
                  href={"/contact"}
                  className={styles.primary63}
                  data-framecoded-trigger={"h1oo9t8k"}
                  data-framecoded-state={"h1oo9t8ksroot"}
                >
                  <div className={styles.about6} data-framecoded-state={"h1oo9t8ks0"}>
        ...
        <div className={styles.image37}>
          <div className={styles.top17}>
            ...
            <div className={styles.socialIcons}>
              ...
              <div className={styles.div164}>
                <a
                  href={"https://www.instagram.com/"}
                  target={"_blank"}
                  rel="noopener noreferrer"
                  className={styles.primary66}
                  data-border={"true"}
      ...
      <div className={styles.bottom15}>
        ...
        <Link href={"/about#top"} className={styles.backToTop} data-framecoded-motion={"r79j"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p835Pm3}>
              <p className={styles.p835Pm4}>8:35 PM</p>
            </div>
          </div>
        </div>
      </div>
