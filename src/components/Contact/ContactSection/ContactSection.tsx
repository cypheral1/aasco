    ...
    <section className={styles.contactSection}>
      <div className={styles.connectWithOur}>
          ...
          <div className={styles.left}>
            <div className={styles.title}>
              <div className={styles.top2}>
                ...
                <div className={styles.ourApproach} data-framecoded-motion={"r5mq"}>
                  <h5 className={styles.h52} dir={"auto"}>
                    Connect With Our Team
                  </h5>
                </div>
              </div>
              <div className={styles.image} data-framecoded-motion={"r5mu"}>
                <div className={styles.image2}>
                  <Image
                    className={styles.image3}
                    src={"/assets/3lZa2fwWPbIG54wb4TwJPujB5M-2516938ca8.png"}
                    alt={"image"}
                    width={1436}
                    height={852}
                    srcSet={
                      "/assets/3lZa2fwWPbIG54wb4TwJPujB5M-c239102db8.png 512w,/assets/3lZa2fwWPbIG54wb4TwJPujB5M-6705ad1f0c.png 1024w,/assets/3lZa2fwWPbIG54wb4TwJPujB5M-2516938ca8.png 1436w"
                    }
                    sizes={
                      "(min-width: 1440px) 359px, (min-width: 810px) and (max-width: 1439.98px) 359px, (max-width: 809.98px) 359px"
                    }
                  />
                </div>
              </div>
            ...
            <div className={styles.bottom}>
              ...
              <div className={styles.startProject6}>
                <Link
                  ...
                  data-border={"true"}
                  data-framecoded-trigger={"her8su3"}
                >
                  <div className={styles.filler2} data-framecoded-state={"her8su3s0"}></div>
                  <div className={styles.startProject7} data-framecoded-state={"her8su3s1"}>
                    <div className={styles.startProject32} data-framecoded-state={"her8su3s1_0"}>
                      <p className={styles.startProject8} dir={"auto"}>
                        Start Project
                      </p>
                    </div>
                    <div className={styles.startProject42} data-framecoded-state={"her8su3s1_1"}>
              ...
              <div className={styles.submit2}>
                ...
                >
                  <div className={styles.submit3}>
                    <p className={styles.submit4} dir={"auto"}>
                      Submit
                    </p>
                  </div>
                </button>
        ...
        <div className={styles.logoImage2}>
          <div className={styles.clientTicker} data-framecoded-motion={"r5pt"}>
            <ul className={styles.logoImageList} data-framecoded-motion={"r5ps"}>
              <li
              ...
              >
                <div className={styles.logoImage3}>
                  <div className={styles.primary4}>
                    <div className={styles.logoImage4}>
                      <Image
              ...
              >
                <div className={styles.logoImage6}>
                  <div className={styles.primary5}>
                    <div className={styles.logoImage7}>
                      <Image
                        className={styles.logoImage8}
                        src={
              ...
              >
                <div className={styles.logoImage9}>
                  <div className={styles.primary6}>
                    <div className={styles.logoImage10}>
                      <Image
                        className={styles.logoImage11}
              ...
              >
                <div className={styles.logoImage12}>
                  <div className={styles.primary7}>
                    <div className={styles.logoImage13}>
                      <Image
                        className={styles.logoImage14}
              ...
              >
                <div className={styles.logoImage15}>
                  <div className={styles.primary8}>
                    <div className={styles.logoImage16}>
                      <Image
                        className={styles.logoImage17}
                        src={
              ...
              >
                <div className={styles.logoImage18}>
                  <div className={styles.primary9}>
                    <div className={styles.logoImage19}>
                      <Image
                        className={styles.logoImage20}
                        src={
            ...
            <div className={styles.logoImage21}>
              <div className={styles.primary32}>
                <div className={styles.logoImage22}>
                  <Image
                    className={styles.logoImage23}
                    src={
                      "https://framerusercontent.com/images/D7tAGQwuEagclYJFUUfjpnA.svg?width=169&height=40"
                    }
                    alt={"logo image"}
            ...
            <div className={styles.logoImage24}>
              <div className={styles.primary42}>
                <div className={styles.logoImage25}>
                  <Image
                    className={styles.logoImage26}
                    src={"/assets/dCWcneZNNMYJrzn6nzE2HjzFEA-8dc4a4a7c4.svg"}
                    alt={"logo image"}
                    width={78}
                    height={30}
            ...
            <div className={styles.logoImage27}>
              <div className={styles.primary52}>
                <div className={styles.logoImage28}>
                  <Image
                    className={styles.logoImage29}
                    src={"/assets/c9MFXPlSLp5Dqz5cOPVbLM1Hnwg-2333cd0ba3.svg"}
                    alt={"logo image"}
                    width={105}
                    height={40}
            ...
            <div className={styles.logoImage30}>
              <div className={styles.primary62}>
                <div className={styles.logoImage31}>
                  <Image
                    className={styles.logoImage32}
                    src={
                      "https://framerusercontent.com/images/YANi1wwFsVONeFrOhRxm7r6J4.svg?width=49&height=48"
                    }
                    alt={"logo image"}
            ...
            <div className={styles.logoImage33}>
              <div className={styles.primary72}>
                <div className={styles.logoImage34}>
                  <Image
                    className={styles.logoImage35}
                    src={
                      "https://framerusercontent.com/images/WK4hKH0krVysKoT16gJKJqC9zIo.svg?width=100&height=50"
                    }
                    alt={"logo image"}
