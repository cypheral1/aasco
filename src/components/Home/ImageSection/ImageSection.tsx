...
export function ImageSection() {
  return (
    <section className={styles.imageSection}>
      <div className={styles.bgImage42}>
        <div className={styles.image227}>
          <Image
      ...
      <div className={styles.top64}>
          ...
          <div className={styles.location}>
            ...
            <div className={styles.no152ThatcherRoadNewYorkNY10012}>
              <p className={styles.no152Thatcher} dir={"auto"}>
                Krishna Arcade, Shop No-05, Plot-6, Sec-11, Taloja Phase-1, Near Maharashtra Bank, Navi Mumbai - 410208
              </p>
            </div>
          </div>
          <div className={styles.rotatingCircle}>
            <div className={styles.card} data-border={"true"}>
              <div className={styles.image229}>
              ...
              <div className={styles.div515}>
                <div className={styles.div514}>
                  <span
                    className={styles.icon78}
                    data-framecoded-motion={"r21h"}
          ...
          <div className={styles.menuLinks}>
            ...
            <div className={styles.list}>
              <div className={styles.about2}>
                <Link href={"/about"} className={styles.primary196}>
              ...
              <div className={styles.work}>
                <Link href={"/works"} className={styles.primary197}>
                  <div className={styles.about22}>
              ...
              <div className={styles.news}>
                <Link href={"/news"} className={styles.primary198}>
                  <div className={styles.about32}>
              ...
              <div className={styles.privacy}>
                <Link href={"/privacy-policy"} className={styles.primary199}>
              ...
              <div className={styles.contact2}>
                <Link href={"/contact"} className={styles.primary200}>
        ...
        <div className={styles.image232}>
          <div className={styles.top62}>
            <div className={styles.image233}>
              <Link href={"/#top"} className={styles.logoImage}>
                <div className={styles.image234}>
                  <Image
                    className={styles.image235}
              ...
              <div className={styles.weHopeToEmpowerUserAndSimplifyTheirEverydayLives}>
                <p className={styles.weHopeTo} dir={"auto"}>
                  <span className={styles.weHopeTo2}>Turning property dreams into reality</span>
                </p>
            ...
            <div className={styles.socialIcons2}>
              <div className={styles.div522}>
                <a
                  href={"https://twitter.com"}
                  target={"_blank"}
                  rel="noopener noreferrer"
                  className={styles.primary201}
                  data-border={"true"}
                >
                  <span
                    className={styles.icon79}
                    data-framecoded-svg="true"
                    aria-hidden="true"
                    dangerouslySetInnerHTML={{
                      __html:
              ...
              <div className={styles.div523}>
                <a
                  href={"https://dribbble.com/"}
                  target={"_blank"}
                  rel="noopener noreferrer"
                  className={styles.primary202}
                  data-border={"true"}
                >
                  <span
                    className={styles.icon80}
                    data-framecoded-svg="true"
                    aria-hidden="true"
                    dangerouslySetInnerHTML={{
                      __html:
              ...
              <div className={styles.div524}>
                <a
                  href={"https://www.instagram.com/"}
                  target={"_blank"}
                  rel="noopener noreferrer"
                  className={styles.primary203}
                  data-border={"true"}
                >
                  <span
                    className={styles.icon81}
                    data-framecoded-svg="true"
                    aria-hidden="true"
                    dangerouslySetInnerHTML={{
                      __html:
              ...
              <div className={styles.div525}>
                <a
                  href={"https://www.behance.net/"}
                  target={"_blank"}
                  rel="noopener noreferrer"
                  className={styles.primary204}
                  data-border={"true"}
                >
                  <span
                    className={styles.icon82}
                    data-framecoded-svg="true"
                    aria-hidden="true"
                    dangerouslySetInnerHTML={{
                      __html:
          ...
          <div className={styles.bottom47}>
            <div className={styles.top63}>
              <div className={styles.newsletter2}>
                <span
                  className={styles.icon83}
                  data-framecoded-svg="true"
                  aria-hidden="true"
                  dangerouslySetInnerHTML={{
                    __html:
              ...
              <form className={styles.form2} action={"mailto:info@aasco.co.in"} method={"post"} encType={"text/plain"}>
                <label className={styles.label6}>
                  <div className={styles.div526}>
                    <input
                  ...
                  <div className={styles.div529}>
                    <button className={styles.default_4} type={"submit"} data-reset={"button"}>
                      <div className={styles.div528}>
                        <div className={styles.div527}>
                          <span
                            className={styles.icon84}
                            data-framecoded-svg="true"
                            aria-hidden="true"
                            dangerouslySetInnerHTML={{
                              __html:
      ...
      <div className={styles.bottom48}>
        ...
        <Link href={"/#top"} className={styles.backToTop} data-framecoded-motion={"r248"}>
          <div className={styles.arrowUp10} aria-hidden={"true"}>
            <div className={styles.div530}>
              <span
                className={styles.icon85}
                data-framecoded-svg="true"
                aria-hidden="true"
                dangerouslySetInnerHTML={{
                  __html:
        ...
        <div className={styles.time3} data-framecoded-state={"hhvt1xzs31719"}>
          <div className={styles.time2} data-framecoded-state={"hhvt1xzs31720"}>
            <div className={styles.newYorkUSA22}>
              <p className={styles.newYorkUSA4} dir={"auto"}>
                Navi Mumbai, India -{" "}
              </p>
            </div>
            <div className={styles.p831Pm3} data-framecoded-state={"hhvt1xzs31723"}>
              <p className={styles.p831Pm4} data-framecoded-state={"hhvt1xzs31724"}>
                10:00 AM - 8:00 PM
              </p>
            </div>
          </div>
