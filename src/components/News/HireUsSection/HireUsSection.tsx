  ...
  return (
    <section className={styles.hireUsSection}>
      <div className={styles.hireUs}>
        <div className={styles.contact}>
          <div className={styles.left}>
            <div className={styles.title}>
              ...
              <div className={styles.ourApproach} data-framecoded-motion={"rd4d"}>
        ...
        <div className={styles.clientTicker} data-framecoded-motion={"rd7b"}>
          <ul className={styles.logoImageList} data-framecoded-motion={"rd7a"}>
            <li
