  ...
  return (
    <section className={styles.imageSection}>
              ...
              <div className={styles.news4}>
                ...
                >
                  <div className={styles.about32} data-framecoded-state={"h1ekoo6ws0"}>
                    <p className={styles.news5} dir={"auto"}>
                      News
                    </p>
                  </div>
                </Link>
      ...
      <div className={styles.bottom3}>
        ...
        <Link href={"/news#top"} className={styles.backToTop} data-framecoded-motion={"rdar"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p843Pm3}>
              <p className={styles.p843Pm4}>8:43 PM</p>
            </div>
          </div>
        </div>
      </div>
