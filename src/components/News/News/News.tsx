...
export function News() {
  return (
    <div className={styles.news2} id={"main"}>
      <section className={styles.newsSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"rd0s"}>
        ...
        <div className={styles.div56} id={"overlay"}></div>
        <div className={styles.div57}></div>
