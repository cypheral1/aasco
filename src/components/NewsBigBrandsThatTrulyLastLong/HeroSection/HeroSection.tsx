...
export function HeroSection() {
  return (
    <section className={styles.heroSection}>
      ...
      <Link href={"/#top"} className={styles.logo} data-framecoded-motion={"rh6f"}>
      ...
      <div className={styles.heading}>
        <div className={styles.visualBrandAndStorytelling} data-framecoded-motion={"rh6h"}>
          <h2 className={styles.h2} dir={"auto"}>
            Big Brands That Truly Last long
          </h2>
        </div>
        <div className={styles.details} data-framecoded-motion={"rh6u"}>
          <div className={styles.whereDesignSpeaksBeforeWordsAndEveryVisualCarriesMeaning}>
            <p className={styles.builtOnClarity} dir={"auto"}>
              Built on clarity, driven by purpose, and designed to stand the test of time.
            </p>
          </div>
          <div className={styles.bottom}>
            <div className={styles.left}>
              ...
              <div className={styles.p2ndDec2025}>
                <p className={styles.p3rdJan2026} dir={"auto"}>
                  3rd Jan 2026
                </p>
              </div>
            </div>
      ...
      <div className={styles.detailPlus1} data-framecoded-motion={"rh6z"}>
        <div className={styles.plus}>
          <div className={styles.el}></div>
          <div className={styles.el2}></div>
        </div>
      </div>
      <div className={styles.detailPlus2} data-framecoded-motion={"rh73"}>
        <div className={styles.plus2}>
          <div className={styles.el3}></div>
          <div className={styles.el4}></div>
        </div>
      </div>
      <div className={styles.detailPlus3} data-framecoded-motion={"rh77"}>
