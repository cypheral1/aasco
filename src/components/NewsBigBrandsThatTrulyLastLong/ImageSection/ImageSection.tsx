  ...
  return (
    <section className={styles.imageSection}>
      ...
      <div className={styles.bottom3}>
        ...
        <Link href={"/news#top"} className={styles.backToTop} data-framecoded-motion={"rhc1"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p850Pm3}>
              <p className={styles.p850Pm4}>8:50 PM</p>
            </div>
          </div>
        </div>
      </div>
