import styles from "./NewsBigBrandsThatTrulyLastLong.module.css";
import Link from "next/link";
import { ContentSection } from "../ContentSection";
import { HeroSection } from "../HeroSection";
import { ImageSection } from "../ImageSection";

export function NewsBigBrandsThatTrulyLastLong() {
  return (
    <div className={styles.bigBrandsThat} id={"main"}>
      <section className={styles.bigBrandsThatSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"rh67"}>
              <div className={styles.menuTime}>
                ...
                <div className={styles.time}>
                  ...
                  <div className={styles.p850Pm}>
                    <p className={styles.p850Pm2}>8:50 PM</p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.bigBrandsThat2}>
          <HeroSection />
          <ContentSection />
        </div>
