  ...
  return (
    <section className={styles.imageSection}>
      ...
      <div className={styles.bottom3}>
        ...
        <Link href={"/news#top"} className={styles.backToTop} data-framecoded-motion={"rgsp"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p849Pm3}>
              <p className={styles.p849Pm4}>8:49 PM</p>
            </div>
          </div>
        </div>
      </div>
