import styles from "./NewsTrendsShapingTheFuture.module.css";
import Link from "next/link";
import { ContentSection } from "../ContentSection";
import { HeroSection } from "../HeroSection";
import { ImageSection } from "../ImageSection";

export function NewsTrendsShapingTheFuture() {
  return (
    <div className={styles.trendsShapingThe} id={"main"}>
      <section className={styles.trendsShapingTheSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"rgmv"}>
              <div className={styles.menuTime}>
                ...
                <div className={styles.time}>
                  ...
                  <div className={styles.p849Pm}>
                    <p className={styles.p849Pm2}>8:49 PM</p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.trendsShapingThe2}>
          <HeroSection />
          <ContentSection />
        </div>
