...
export function HeroSection() {
  return (
    <section className={styles.heroSection}>
      ...
      <Link href={"/#top"} className={styles.logo} data-framecoded-motion={"rg3r"}>
      ...
      <div className={styles.heading}>
        <div className={styles.visualBrandAndStorytelling} data-framecoded-motion={"rg3t"}>
          <h2 className={styles.h2} dir={"auto"}>
            Visual Brand And Storytelling
          </h2>
        </div>
        <div className={styles.details} data-framecoded-motion={"rg46"}>
          <div className={styles.whereDesignSpeaksBeforeWordsAndEveryVisualCarriesMeaning}>
            <p className={styles.whereDesignSpeaks} dir={"auto"}>
              Where design speaks before words and every visual carries meaning.
            </p>
          </div>
          <div className={styles.bottom}>
            <div className={styles.left}>
              ...
              <div className={styles.p2ndDec2025}>
                <p className={styles.p2ndDec20252} dir={"auto"}>
                  2nd Dec 2025
                </p>
              </div>
            </div>
      ...
      <div className={styles.detailPlus1} data-framecoded-motion={"rg4b"}>
        <div className={styles.plus}>
          <div className={styles.el}></div>
          <div className={styles.el2}></div>
        </div>
      </div>
      <div className={styles.detailPlus2} data-framecoded-motion={"rg4f"}>
        <div className={styles.plus2}>
          <div className={styles.el3}></div>
          <div className={styles.el4}></div>
        </div>
      </div>
      <div className={styles.detailPlus3} data-framecoded-motion={"rg4j"}>
