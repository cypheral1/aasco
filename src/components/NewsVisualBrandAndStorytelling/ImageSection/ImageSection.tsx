  ...
  return (
    <section className={styles.imageSection}>
              ...
              <div className={styles.contact}>
                ...
                >
                  <div className={styles.about5} data-framecoded-state={"h1lk4yi3s0"}>
                    <p className={styles.contact2} dir={"auto"}>
                      Contact
                    </p>
                  </div>
                </Link>
      ...
      <div className={styles.bottom3}>
        ...
        <Link href={"/news#top"} className={styles.backToTop} data-framecoded-motion={"rg9d"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p848Pm3}>
              <p className={styles.p848Pm4}>8:48 PM</p>
            </div>
          </div>
        </div>
      </div>
