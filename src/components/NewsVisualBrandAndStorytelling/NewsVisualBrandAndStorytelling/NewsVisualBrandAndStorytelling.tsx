import styles from "./NewsVisualBrandAndStorytelling.module.css";
import Link from "next/link";
import { ContentSection } from "../ContentSection";
import { HeroSection } from "../HeroSection";
import { ImageSection } from "../ImageSection";

export function NewsVisualBrandAndStorytelling() {
  return (
    <div className={styles.visualBrandAnd} id={"main"}>
      <section className={styles.visualBrandAndSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"rg3j"}>
              <div className={styles.menuTime}>
                ...
                <div className={styles.time}>
                  ...
                  <div className={styles.p848Pm}>
                    <p className={styles.p848Pm2}>8:48 PM</p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.visualBrandAnd2}>
          <HeroSection />
          <ContentSection />
        </div>
        <div className={styles.div15} id={"overlay"}></div>
