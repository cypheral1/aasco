              ...
              <div className={styles.privacy4}>
                ...
                >
                  <div className={styles.about4} data-framecoded-state={"h2a4k0as0"}>
                    <p className={styles.privacy5} dir={"auto"}>
                      Privacy
                    </p>
                  </div>
                </Link>
              ...
              <div className={styles.contact3}>
                ...
                >
                  <div className={styles.about5} data-framecoded-state={"h1pi8mbhs0"}>
                    <p className={styles.contact4} dir={"auto"}>
                      Contact
                    </p>
                  </div>
                </Link>
      ...
      <div className={styles.bottom2}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p844Pm3}>
              <p className={styles.p844Pm4}>8:44 PM</p>
            </div>
          </div>
        </div>
      </div>
