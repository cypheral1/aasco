  ...
  return (
    <section className={styles.hireUsSection}>
      <div className={styles.hireUs}>
        <div className={styles.contact}>
          <div className={styles.left3}>
            <div className={styles.title}>
              ...
              <div className={styles.ourApproach} data-framecoded-motion={"rb8d"}>
        ...
        <div className={styles.clientTicker} data-framecoded-motion={"rbbb"}>
          <ul className={styles.logoImageList} data-framecoded-motion={"rbba"}>
            <li
