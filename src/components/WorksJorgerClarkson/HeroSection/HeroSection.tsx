...
export function HeroSection() {
  return (
    <section className={styles.heroSection}>
      ...
      <Link href={"/#top"} className={styles.logo} data-framecoded-motion={"r9lv"}>
      ...
      <div className={styles.workDetails}>
        <div className={styles.left2}>
          <header className={styles.jorgerClarksonHeader}>
            <div className={styles.unerioLandingPage} data-framecoded-motion={"r9lx"}>
              <h2 className={styles.h2} dir={"auto"}>
                Jorger Clarkson
              </h2>
            </div>
            <div className={styles.details} data-framecoded-motion={"r9ma"}>
              <div
                className={
              ...
              >
                <p className={styles.strategicPersonalBranding} dir={"auto"}>
                  Strategic personal branding andSEO optimization to amplifydigital authority.
                </p>
              </div>
              <div className={styles.bottom}>
                ...
                <div className={styles.fOUNDATION}>
                  <p className={styles.branding} dir={"auto"}>
                    BRANDING
                  </p>
                </div>
              </div>
          ...
          <div className={styles.bottom2}>
            <div className={styles.projectOverview2} data-framecoded-motion={"r9ml"}>
              ...
              <div className={styles.projectOverview3}>
                ...
                <div className={styles.contentBox}>
                  ...
                  >
                    <p className={styles.jorgerClarksonIs} dir={"auto"}>
                      Jorger Clarkson is envisioned as a bold and contemporary brand that blends
                      sophistication with a strong, distinctive personality. The goal of the
                      branding project was to create a visual and emotional identity that feels
                      premium.
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <p className={styles.theBrandFocuses} dir={"auto"}>
                      The brand focuses on building a memorable presence through clean aesthetics,
                      confident messaging, and a cohesive visual language. Every element was
                      designed to reflect clarity, trust, and a forward-thinking, positioning Jorger
                      Clarkson as a standout name in its space.
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <div className={styles.designProcess} data-framecoded-motion={"r9mv"}>
                ...
                <div className={styles.contentBox2}>
                  ...
                  >
                    <p className={styles.theProcessBegan} dir={"auto"}>
                      The process began with deep research into the brand’s target audience,
                      competitors, and market positioning to identify a unique voice. From there,
                      mood boards and visual exploration were created to define the tone—balancing
                      minimalism with expressive details.
                    </p>
                  </div>
                  <div
                    className={
                  ...
                  >
                    <p className={styles.typographyPlayedKey} dir={"auto"}>
                      Typography played a key role, with modern, structured fonts chosen to convey
                      strength and elegance. The color palette was carefully curated to evoke
                      sophistication.
                    </p>
                  </div>
                </div>
            ...
            <div className={styles.finalOutcome} data-framecoded-motion={"r9n5"}>
              ...
              <div className={styles.finalOutcome2}>
                ...
                <div className={styles.contentBox3}>
                  ...
                  >
                    <p className={styles.theFinalOutcome} dir={"auto"}>
                      The final outcome is a cohesive and striking brand identity that captures
                      attention while maintaining a refined aesthetic. Jorger Clarkson now holds a
                      clear visual voice that communicates confidence, quality, and modern appeal.
                    </p>
                  </div>
                  <div
                    className={
                  ...
                  >
                    <p className={styles.theBrandingSystem} dir={"auto"}>
                      The branding system is flexible, allowing it to scale seamlessly across
                      platforms such as websites, social media, and packaging.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.image}>
          <div className={styles.coverImage} data-framecoded-motion={"r9nn"}>
