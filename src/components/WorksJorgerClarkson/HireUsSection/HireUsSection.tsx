  ...
  return (
    <section className={styles.hireUsSection}>
      <div className={styles.hireUs}>
        <div className={styles.contact}>
          <div className={styles.left3}>
            <div className={styles.title}>
              ...
              <div className={styles.ourApproach} data-framecoded-motion={"r9nx"}>
        ...
        <div className={styles.clientTicker} data-framecoded-motion={"r9qv"}>
          <ul className={styles.logoImageList} data-framecoded-motion={"r9qu"}>
            <li
