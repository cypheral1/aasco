  ...
  return (
    <section className={styles.imageSection}>
            ...
            <div className={styles.list}>
              <div className={styles.about2}>
                <Link
                  ...
                  data-framecoded-trigger={"h1m47fv2"}
                  data-framecoded-state={"h1m47fv2sroot"}
                >
                  <div className={styles.about} data-framecoded-state={"h1m47fv2s0"}>
              ...
              <div className={styles.work}>
                <Link
                  ...
                  data-framecoded-trigger={"h1k24a5d"}
                  data-framecoded-state={"h1k24a5dsroot"}
                >
                  <div className={styles.about22} data-framecoded-state={"h1k24a5ds0"}>
              ...
              <div className={styles.news}>
                <Link
                  ...
                  data-framecoded-trigger={"h15447da"}
                  data-framecoded-state={"h15447dasroot"}
                >
                  <div className={styles.about32} data-framecoded-state={"h15447das0"}>
              ...
              <div className={styles.privacy}>
                <Link
                  href={"/privacy-policy"}
                  className={styles.primary14}
                  data-framecoded-trigger={"h1env5qg"}
                  data-framecoded-state={"h1env5qgsroot"}
                >
                  <div className={styles.about4} data-framecoded-state={"h1env5qgs0"}>
              ...
              <div className={styles.contact2}>
                <Link
                  href={"/contact"}
                  className={styles.primary15}
                  data-framecoded-trigger={"h1lk4yi3"}
                  data-framecoded-state={"h1lk4yi3sroot"}
                >
                  <div className={styles.about5} data-framecoded-state={"h1lk4yi3s0"}>
      ...
      <div className={styles.bottom5}>
        ...
        <Link href={"/works#top"} className={styles.backToTop} data-framecoded-motion={"r9ub"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p838Pm3}>
              <p className={styles.p838Pm4}>8:38 PM</p>
            </div>
          </div>
        </div>
      </div>
