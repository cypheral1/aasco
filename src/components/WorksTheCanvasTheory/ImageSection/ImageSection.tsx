  ...
  return (
    <section className={styles.imageSection}>
      ...
      <div className={styles.bottom5}>
        ...
        <Link href={"/works#top"} className={styles.backToTop} data-framecoded-motion={"rfjz"}>
        ...
        <div className={styles.time3}>
          <div className={styles.time2}>
            ...
            <div className={styles.p847Pm3}>
              <p className={styles.p847Pm4}>8:47 PM</p>
            </div>
          </div>
        </div>
      </div>
