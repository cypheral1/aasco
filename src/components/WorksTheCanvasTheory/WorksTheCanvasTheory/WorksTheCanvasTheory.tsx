import styles from "./WorksTheCanvasTheory.module.css";
import Link from "next/link";
import { HeroSection } from "../HeroSection";
import { HireUsSection } from "../HireUsSection";
import { ImageSection } from "../ImageSection";

export function WorksTheCanvasTheory() {
  return (
      ...
      <section className={styles.logoSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"rfbb"}>
              <div className={styles.menuTime}>
                ...
                <div className={styles.time}>
                  ...
                  <div className={styles.p847Pm}>
                    <p className={styles.p847Pm2}>8:47 PM</p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.theCanvasTheory}>
          <HeroSection />
