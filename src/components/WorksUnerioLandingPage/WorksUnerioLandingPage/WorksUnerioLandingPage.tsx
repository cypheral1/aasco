import styles from "./WorksUnerioLandingPage.module.css";
import Link from "next/link";
import { HeroSection } from "../HeroSection";
import { HireUsSection } from "../HireUsSection";
import { ImageSection } from "../ImageSection";

export function WorksUnerioLandingPage() {
  return (
      ...
      <section className={styles.logoSection} data-layout-template={"true"}>
        <div className={styles.div6}>
          <div className={styles.newYorkUSA2}>
            <div className={styles.menu2} data-framecoded-motion={"r8tf"}>
              <div className={styles.menuTime}>
                ...
                <div className={styles.time}>
                  ...
                  <div className={styles.p836Pm}>
                    <p className={styles.p836Pm2}>8:36 PM</p>
                  </div>
                </div>
              </div>
